...
#include "opencat_msgs/srv/detail/base_task__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = opencat_msgs::srv::BaseTask_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const opencat_msgs::srv::BaseTask_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<opencat_msgs::srv::BaseTask_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BaseTask_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const opencat_msgs::srv::BaseTask_Request *>(
...
static size_t _BaseTask_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BaseTask_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BaseTask_Request__callbacks = {
  "opencat_msgs::srv",
  "BaseTask_Request",
...
static rosidl_message_type_support_t _BaseTask_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BaseTask_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_opencat_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<opencat_msgs::srv::BaseTask_Request>()
{
  return &opencat_msgs::srv::typesupport_fastrtps_cpp::_BaseTask_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = opencat_msgs::srv::BaseTask_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const opencat_msgs::srv::BaseTask_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<opencat_msgs::srv::BaseTask_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BaseTask_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const opencat_msgs::srv::BaseTask_Response *>(
...
static size_t _BaseTask_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BaseTask_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BaseTask_Response__callbacks = {
  "opencat_msgs::srv",
  "BaseTask_Response",
...
static rosidl_message_type_support_t _BaseTask_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BaseTask_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &opencat_msgs::srv::typesupport_fastrtps_cpp::_BaseTask_Response__handle;
}
...
static service_type_support_callbacks_t _BaseTask__callbacks = {
  "opencat_msgs::srv",
  "BaseTask",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opencat_msgs, srv, BaseTask_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opencat_msgs, srv, BaseTask_Response)(),
...
static rosidl_service_type_support_t _BaseTask__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BaseTask__callbacks,
...
{
  return &opencat_msgs::srv::typesupport_fastrtps_cpp::_BaseTask__handle;
}
