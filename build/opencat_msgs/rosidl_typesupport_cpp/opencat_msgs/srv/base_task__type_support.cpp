...
static const _BaseTask_Request_type_support_symbol_names_t _BaseTask_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opencat_msgs, srv, BaseTask_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, opencat_msgs, srv, BaseTask_Request)),
  }
};
...
{
  return &::opencat_msgs::srv::rosidl_typesupport_cpp::BaseTask_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, opencat_msgs, srv, BaseTask_Request)() {
  return get_message_type_support_handle<opencat_msgs::srv::BaseTask_Request>();
}
...
static const _BaseTask_Response_type_support_symbol_names_t _BaseTask_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opencat_msgs, srv, BaseTask_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, opencat_msgs, srv, BaseTask_Response)),
  }
};
...
{
  return &::opencat_msgs::srv::rosidl_typesupport_cpp::BaseTask_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, opencat_msgs, srv, BaseTask_Response)() {
  return get_message_type_support_handle<opencat_msgs::srv::BaseTask_Response>();
}
...
static const _BaseTask_type_support_symbol_names_t _BaseTask_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opencat_msgs, srv, BaseTask)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, opencat_msgs, srv, BaseTask)),
  }
};
...
{
  return &::opencat_msgs::srv::rosidl_typesupport_cpp::BaseTask_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, opencat_msgs, srv, BaseTask)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<opencat_msgs::srv::BaseTask>();
}
