...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/install/gesture_legs_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gesture_legs_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gesture_legs_control/environment/path.sh"
